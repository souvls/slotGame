            ...
            <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    ...
                    <ul class="space-y-2 font-medium">
                        <li>
                            <Link href="/admin/office" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example1" data-collapse-toggle="dropdown-example1">
                                ...
                                <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap"><p>ຈັດການເອເຢັ້ນ</p></span>
                            ...
                            <ul id="dropdown-example1" class="hidden py-2 space-y-2">
                                <li>
                                    <Link href="/admin/office/members" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"><p>ລາຍຊື່ເອເຢັ້ນ</p></Link>
                                </li>
                                <li>
                                    <Link href="/admin/office/members/create" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"><p>ເພີ່ມເອເຢັ້ນ</p></Link>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul id="dropdown-example2" class="hidden py-2 space-y-2">
                                <li>
                                    <a href="/admin/office/history/member" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"><p>ປະຫວັດເຄດິດເອເຢັ້ນ</p></a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="/admin/office/history/user" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"><p>ປະຫວັດຫຼິ້ນເກມ</p></a>
                                </li>
                            </ul>
                        </li>
                        <li>
